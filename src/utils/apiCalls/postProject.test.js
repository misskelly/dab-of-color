...
describe('postProject', () => {
  ...
  it('should return project id with successfull fetch', async () => {
    const expected = { id: 1 };
    const result = await postProject(mockUrl, mockBody);
  ...
  it('should return an error if post fails', async () => {
    ...
    await expect(postProject(mockUrl, mockBody)).rejects.toEqual(expected);
  });
});
